...
@.str.1 = private unnamed_addr constant [16 x i8] c"munmap failed!\0A\00", align 1
@.str.2 = private unnamed_addr constant [40 x i8] c"miss: %llu, hit: %llu, threshold: %llu\0A\00", align 1
@.str.3 = private unnamed_addr constant [44 x i8] c"ERROR: Entries are bigger than cache line!\0A\00", align 1
@.str.4 = private unnamed_addr constant [28 x i8] c"Could not allocate chunks!\0A\00", align 1
@.str.5 = private unnamed_addr constant [29 x i8] c"Could not allocate ichunks!\0A\00", align 1
@.str.6 = private unnamed_addr constant [43 x i8] c"Could not allocate back (%d, %f, %f, %d)!\0A\00", align 1
...
78:                                               ; preds = %74
  ...
  %80 = load i64, ptr @evset_memory_size, align 8
  %81 = call i32 @"\01_munmap"(ptr noundef %79, i64 noundef %80)
  %82 = load i64, ptr @evset_memory_size, align 8
  %83 = call ptr @"\01_mmap"(ptr noundef null, i64 noundef %82, i32 noundef 3, i32 noundef 4098, i32 noundef 0, i64 noundef 0)
  ...
  %88 = load i64, ptr @evset_memory_size, align 8
  %89 = load i64, ptr %3, align 8
  call void @initialize_list(ptr noundef %87, i64 noundef %88, i64 noundef %89)
  store ptr null, ptr %9, align 8
...
101:                                              ; preds = %98
  ...
  %103 = getelementptr inbounds %struct.elem, ptr %102, i32 0, i32 0
  %104 = load ptr, ptr %103, align 8
  store ptr %104, ptr %11, align 8
  %105 = load ptr, ptr %9, align 8
  %106 = ptrtoint ptr %105 to i64
  %107 = load i64, ptr @page_size, align 8
  %108 = sub i64 %107, 1
  %109 = xor i64 %108, -1
  %110 = and i64 %106, %109
  %111 = inttoptr i64 %110 to ptr
  %112 = load i64, ptr @page_size, align 8
  %113 = call i32 @"\01_munmap"(ptr noundef %111, i64 noundef %112)
...
120:                                              ; preds = %119, %48
  ...
  %122 = load ptr, ptr @eviction_sets, align 8
  %123 = load i32, ptr @evsets_count, align 4
  %124 = sub nsw i32 %123, 1
  %125 = sext i32 %124 to i64
  %126 = getelementptr inbounds ptr, ptr %122, i64 %125
  store ptr %121, ptr %126, align 8
  %127 = load i64, ptr %5, align 8
  %128 = load ptr, ptr @eviction_sets_pages, align 8
  %129 = load i32, ptr @evsets_count, align 4
...
68:                                               ; preds = %40
  ...
  %75 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, i32 noundef %69, double noundef %70, double noundef %71, i32 noundef %74)
...
133:                                              ; preds = %128, %125
  ...
  br i1 %134, label %109, label %135, !llvm.loop !12
...
231:                                              ; preds = %227, %224
  ...
  br i1 %232, label %79, label %233, !llvm.loop !14
...
7:                                                ; preds = %38, %0
  ...
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %19) #8, !srcloc !16
  ...
  call void asm sideeffect "DMB SY\0AISB SY", "~{memory}"() #8, !srcloc !17
  %31 = load i64, ptr @timestamp, align 8
  store i64 %31, ptr %2, align 8
  call void asm sideeffect "DMB SY\0AISB SY", "~{memory}"() #8, !srcloc !18
  %32 = load ptr, ptr %1, align 8
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %32) #8, !srcloc !19
  call void asm sideeffect "DMB SY\0AISB SY", "~{memory}"() #8, !srcloc !20
...
38:                                               ; preds = %7
  ...
  %40 = icmp eq i64 %39, 0
  br i1 %40, label %7, label %41, !llvm.loop !22
...
6:                                                ; preds = %19, %0
  ...
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %9) #8, !srcloc !23
  ...
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %13) #8, !srcloc !19
  call void asm sideeffect "DMB SY\0AISB SY", "~{memory}"() #8, !srcloc !20
...
19:                                               ; preds = %6
  ...
  %21 = icmp eq i64 %20, 0
  br i1 %21, label %6, label %22, !llvm.loop !24
...
26:                                               ; preds = %16
  ...
  %34 = add i64 %32, %33
  %35 = udiv i64 %34, 4000
  %36 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i64 noundef %28, i64 noundef %30, i64 noundef %35)
...
24:                                               ; preds = %19
  ...
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %25) #8, !srcloc !27
  %26 = load ptr, ptr %6, align 8
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %26) #8, !srcloc !28
  call void asm sideeffect "DMB SY\0AISB SY", "~{memory}"() #8, !srcloc !29
  ...
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %39) #8, !srcloc !19
  call void asm sideeffect "DMB SY\0AISB SY", "~{memory}"() #8, !srcloc !20
...
22:                                               ; preds = %20
  ...
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %23) #8, !srcloc !31
  %24 = load ptr, ptr %3, align 8
  %25 = getelementptr inbounds %struct.elem, ptr %24, i32 0, i32 0
  %26 = load ptr, ptr %25, align 8
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %26) #8, !srcloc !32
  %27 = load ptr, ptr %3, align 8
  %28 = getelementptr inbounds %struct.elem, ptr %27, i32 0, i32 0
  %29 = load ptr, ptr %28, align 8
  %30 = getelementptr inbounds %struct.elem, ptr %29, i32 0, i32 0
  %31 = load ptr, ptr %30, align 8
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %31) #8, !srcloc !33
  %32 = load ptr, ptr %3, align 8
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %32) #8, !srcloc !34
  %33 = load ptr, ptr %3, align 8
  %34 = getelementptr inbounds %struct.elem, ptr %33, i32 0, i32 0
  %35 = load ptr, ptr %34, align 8
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %35) #8, !srcloc !35
  ...
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %40) #8, !srcloc !36
...
define i32 @test_set(ptr noundef %0, ptr noundef %1) #0 {
  ...
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %8) #8, !srcloc !46
  %9 = load ptr, ptr %7, align 8
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %9) #8, !srcloc !47
  call void asm sideeffect "DMB SY\0AISB SY", "~{memory}"() #8, !srcloc !48
  ...
  call void asm sideeffect "DMB SY\0AISB SY", "~{memory}"() #8, !srcloc !18
  %14 = load ptr, ptr %3, align 8
  call void asm sideeffect "LDR x10, [$0]", "r,~{x10},~{memory}"(ptr %14) #8, !srcloc !19
  call void asm sideeffect "DMB SY\0AISB SY", "~{memory}"() #8, !srcloc !20
...
!4 = !{!"clang version 19.0.0git (https://github.com/llvm/llvm-project.git b074f25329501487e312b59e463a2d5f743090f8)"}
!5 = distinct !{!5, !6}
...
!15 = distinct !{!15, !6}
!16 = !{i64 2148445279}
!17 = !{i64 2148444090, i64 2148444099}
!18 = !{i64 2148444158, i64 2148444167}
!19 = !{i64 2148444206}
!20 = !{i64 2148444289, i64 2148444298}
!21 = !{i64 2148444355, i64 2148444364}
!22 = distinct !{!22, !6}
!23 = !{i64 2148445435}
!24 = distinct !{!24, !6}
!25 = distinct !{!25, !6}
...
!27 = !{i64 2148445551}
!28 = !{i64 2148445631}
!29 = !{i64 2148445711, i64 2148445720}
!30 = distinct !{!30, !6}
!31 = !{i64 2148444763}
!32 = !{i64 2148444842}
!33 = !{i64 2148444927}
...
!46 = !{i64 2148446082}
!47 = !{i64 2148446164}
!48 = !{i64 2148446246, i64 2148446255}
!49 = distinct !{!49, !6}
