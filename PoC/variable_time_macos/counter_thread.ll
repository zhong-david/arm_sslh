...
define ptr @counter_thread_thread(ptr noundef %0) #0 {
  ...
  call void asm sideeffect "LDR x10, [$0]\0Aloop:\0AADD x10, x10, #1\0ASTR x10, [$0]\0AB loop\0A", "r,~{x10},~{memory}"(ptr %3) #2, !srcloc !5
  ret ptr null
}
...
!5 = !{i64 258, i64 320, i64 381, i64 446, i64 513}
